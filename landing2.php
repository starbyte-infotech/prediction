...
<body>
    <div class="mobile_body mx-auto bg-primery">
        <div class="row text-white p-4">
            ...
            <div id="pre-1" class="bg-danger text-dark ">
                <div class="wrapper">
                    ...
                    <div class="poll-area">
                      ...
                      <label for="opt-1" class="opt-1 opt1st">
                        <div class="row">
                          <div class="column">
                      ...
                      <label for="opt-2" class="opt-2 opt1st">
                        <div class="row">
                          <div class="column">
                            <span class="circle"></span>
                      ...
                      <label for="opt-3" class="opt-3 opt1st">
                        <div class="row">
                          <div class="column">
                            <span class="circle"></span>
                      ...
                      <label for="opt-4" class="opt-4 opt1st">
                        <div class="row">
                          <div class="column">
                            <span class="circle"></span>
            ...
            <div id="pre-2" class="bg-success text-dark ">
                <div class="wrapper">
                    <header>Poll UI Design</header>
                    <div class="poll-area">
                      <input type="checkbox" name="poll" id="opt-1">
